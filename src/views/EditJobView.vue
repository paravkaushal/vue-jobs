...
const handleSubmit = async () => {
    ...
    try {
        const response = await axios.put(`https://json-server-xguj.onrender.com/jobs/${jobId}`, updatedJob);
...
onMounted(async () => {
    try {
        const response = await axios.get(`https://json-server-xguj.onrender.com/jobs/${jobId}`);
